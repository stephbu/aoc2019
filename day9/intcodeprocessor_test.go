...
func TestInputOutput(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t, 123, proc.memory[0])
}
...
func Test3(t *testing.T) {
	...
	err := proc.DebugProcessor()
	assert.Nil(t, err)
	assert.Equal(t, 99, proc.memory[4])
}
...
func Test6(t *testing.T) {
	...
	err := proc.RunProcessor()
	assert.Nil(t, err)
	assert.Equal(t, 1, proc.memory[9])
}
...
func Test7(t *testing.T) {
	...
	err := proc.RunProcessor()
	assert.Nil(t, err)
	assert.Equal(t, 0, proc.memory[9])
}
...
func Test10(t *testing.T) {
	...
	err := proc.RunProcessor()
	assert.Nil(t, err)
	assert.Equal(t, 1, proc.memory[3])
}
...
func Test11(t *testing.T) {
	...
	err := proc.RunProcessor()
	assert.Nil(t, err)
	assert.Equal(t, 0, proc.memory[3])
}
...
func Test14(t *testing.T) {
	...
	err := proc.RunProcessor()
	assert.Nil(t, err)
	assert.Equal(t, 0, proc.memory[13])
}
...
func Test15(t *testing.T) {
	...
	err := proc.RunProcessor()
	assert.Nil(t, err)
	assert.Equal(t, 1, proc.memory[13])
}
...
func Test16(t *testing.T) {
	...
	err := proc.RunProcessor()
	assert.Nil(t, err)
	assert.Equal(t, 0, proc.memory[12])
}
...
func Test17(t *testing.T) {
	...
	err := proc.RunProcessor()
	assert.Nil(t, err)
	assert.Equal(t, 1, proc.memory[12])
}
...
func Test21(t *testing.T) {
	// relative mode parser
	opcode, mask := ProcessOpCode(204)
	assert.Equal(t, 4, opcode)
	assert.Equal(t, 1, len(mask))
	assert.Equal(t, 2, mask[0])
}

func Test22(t *testing.T) {
	memory := util.StringSplitInt("109,19")
	proc := NewIntCodeProcessor(memory)
	proc.Registers.RelativeBase = 2000
	err := proc.RunProcessor()
	assert.Nil(t, err)
	assert.Equal(t, 2019, proc.Registers.RelativeBase)
}

func Test23(t *testing.T) {
	memory := util.StringSplitInt("109,19,204,-34,99")
	proc := NewIntCodeProcessor(memory)
	proc.Registers.RelativeBase = 2000
	err := proc.RunProcessor()
	assert.Nil(t, err)
	// check memory expanded, memory addresses are zero-based - 1986
	assert.Equal(t, 1986, len(proc.memory))
}

func Test24(t *testing.T) {
	memory := util.StringSplitInt("109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99")
	proc := NewIntCodeProcessor(memory)
	err := proc.RunProcessor()
	assert.Nil(t, err)
	out := proc.GetOutput()
	assert.Equal(t, memory, out)
}

func Test25(t *testing.T) {
	memory := util.StringSplitInt("1102,34915192,34915192,7,4,7,99,0")
	proc := NewIntCodeProcessor(memory)
	err := proc.RunProcessor()
	assert.Nil(t, err)
	out := proc.GetOutput()
...
func Test26(t *testing.T) {
	memory := util.StringSplitInt("104,1125899906842624,99")
	proc := NewIntCodeProcessor(memory)
	err := proc.RunProcessor()
	assert.Nil(t, err)
	out := proc.GetOutput()
...
func Test27(t *testing.T) {
	memory := util.StringSplitInt("203,1,99,0")
	proc := NewIntCodeProcessor(memory)
	proc.Send(666)
	proc.Registers.RelativeBase = 2
	err := proc.RunProcessor()
	assert.Nil(t, err)
	assert.Equal(t, 666, proc.memory[3])
}

// AddRelative RB=5; RB[1] + RB[1] -> Rb[0]
func Test28(t *testing.T) {
	memory := util.StringSplitInt("22201,1,1,0,99,0,2")
	proc := NewIntCodeProcessor(memory)
	proc.Registers.RelativeBase = 5
	err := proc.RunProcessor()
	assert.Nil(t, err)
	assert.Equal(t, 4, proc.memory[proc.Registers.RelativeBase])
}

// AddRelative RB=5; RB[1] + RB[1] -> [0]
func Test29(t *testing.T) {
	memory := util.StringSplitInt("12201,1,1,0,99,0,2")
	proc := NewIntCodeProcessor(memory)
	proc.Registers.RelativeBase = 5
	err := proc.RunProcessor()
	assert.Nil(t, err)
	assert.Equal(t, 4, proc.memory[0])
}
